...
needed_multi_channel_img = np.zeros((red.shape[0], red.shape[1], 3))

"""Add the channels to the needed image one by one"""
needed_multi_channel_img [:,:,0] = green
needed_multi_channel_img [:,:,1] = red
needed_multi_channel_img [:,:,2] = blue

new = (needed_multi_channel_img*image).astype(np.uint8)
plt.imshow(new)
...
mpimg.imsave("../output/out.png", new)
